...
def run_all_tests():
    ...
    try:
        ...
        assert main("fichiers_test/smallboard.txt", debug_mode=True) == True
        ...
        assert main("fichiers_test/tilable4.txt",  debug_mode=False) == True
        ...
        assert main("fichiers_test/nottilable3.txt",   debug_mode=False) == False
